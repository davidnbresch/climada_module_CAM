function climada_tc_analyze_cam_all(basin_number,cam_dataset)
% climada
% NAME:
...
%elseif basin_number==2 % North East Pacific
%    basin_txt='EasPac';
%    basin_coord_rectangle=[-180 -80 0 50]; % lonmin lonmax latmin latmax -> XLim YLim
%    unisys_data_file=[climada_global.root_dir '_additional' filesep 'data' filesep 'tc_tracks' filesep 'tracks.epa.txt'];
%    unisys_tc_track_file=[climada_global.root_dir '_additional' filesep 'data' filesep 'tc_tracks' filesep 'tc_track_epa.mat'];
elseif basin_number==5 % North Indian Ocean
    basin_txt='NorInd';
    basin_coord_rectangle=[30 100 0 40]; % lonmin lonmax latmin latmax -> XLim YLim
    unisys_data_file=[climada_global.root_dir '_additional' filesep 'data' filesep 'tc_tracks' filesep 'tracks.nio.txt'];
    unisys_tc_track_file=[climada_global.root_dir '_additional' filesep 'data' filesep 'tc_tracks' filesep 'tc_track_nio.mat'];
elseif basin_number==4 % S. Pacific and Indian
    basin_txt='SouHem';
    basin_coord_rectangle=[30 190 -50 0]; % lonmin lonmax latmin latmax -> XLim YLim
    unisys_data_file=[climada_global.root_dir '_additional' filesep 'data' filesep 'tc_tracks' filesep 'tracks.she.txt'];
    unisys_tc_track_file=[climada_global.root_dir '_additional' filesep 'data' filesep 'tc_tracks' filesep 'tc_track_she.mat'];
